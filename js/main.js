...
function initGithubDownloadStats() {
  ...
  const CACHE_TTL = 15 * 60 * 1000; // 1 giờ — tránh gọi API liên tục, GitHub giới hạn 60 req/giờ/IP cho request không xác thực
...
function initDownloadPage() {
  ...
  const LINKS = {
    ...
    linux: 'https://github.com/Ryo147/PatchVietHoaInstaller/releases/download/4.2.0.1/PatchVietHoaInstaller-linux.rar'
  };
  const LABELS = {
